...
export type featured_pictureCreationAttributes = Optional<featured_pictureAttributes, featured_picturePk>;

export class featured_picture extends Model<featured_pictureAttributes, featured_pictureCreationAttributes> implements featured_pictureAttributes {
  id!: number;
  picture_id?: number;
  place?: string;

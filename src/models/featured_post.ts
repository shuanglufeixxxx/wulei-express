...
export type featured_postCreationAttributes = Optional<
    featured_postAttributes,
    featured_postPk
>;

export class featured_post
    extends Model<featured_postAttributes, featured_postCreationAttributes>
    implements featured_postAttributes {
    id!: number;
    post_id?: number;

...
export type picture_itemCreationAttributes = Optional<
    picture_itemAttributes,
    picture_itemPk
>;

export class picture_item
    extends Model<picture_itemAttributes, picture_itemCreationAttributes>
    implements picture_itemAttributes {
    id!: number;
    picture_collection_id?: number;
    picture_id?: number;

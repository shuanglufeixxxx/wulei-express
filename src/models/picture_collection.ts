...
export type picture_collectionCreationAttributes = Optional<
    picture_collectionAttributes,
    picture_collectionPk
>;

export class picture_collection
    extends Model<
        picture_collectionAttributes,
        picture_collectionCreationAttributes
    >
    implements picture_collectionAttributes {
    id!: number;

    static initModel(
        sequelize: Sequelize.Sequelize
    ): typeof picture_collection {
